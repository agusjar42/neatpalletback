...
export class EnvioSensorService {
  ...
  /**
   * Inserta en envio_sensor los datos de sensor_empresa para la empresa indicada.
  ...
  async insertEnvioSensor(envioId: number, empresaId: number, usuarioCreacion: number): Promise<void> {
    ...
    //Si existen overrides por empresa (sensor_empresa), se respetan.
    //
