...
@model({settings: {idInjection: false, mysql: {schema: 'neatpallet', table: 'cliente_lugar_parada'}}})
export class LugarParada extends Entity {
  ...
  @property({
    ...
    length: 250,
    generated: false,
    mysql: {columnName: 'nombre', dataType: 'varchar', dataLength: 250, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  nombre: string;
