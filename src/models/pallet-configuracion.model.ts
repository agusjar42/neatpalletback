...
@model({
  settings: {idInjection: false, mysql: {schema: 'neatpallet', table: 'pallet_configuracion'}}
})
export class PalletConfiguracion extends Entity {
  @property({
    type: 'number',
  ...
  constructor(data?: Partial<PalletConfiguracion>) {
    super(data);
  }
}

export interface PalletConfiguracionRelations {
  pallet?: Pallet;
}

export type PalletConfiguracionWithRelations = PalletConfiguracion & PalletConfiguracionRelations;