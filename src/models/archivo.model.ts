...
@model({settings: {idInjection: false, mysql: {schema: 'neatpallet', table: 'archivo'}}})
export class Archivo extends Entity {
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'tipo_archivo_id', dataType: 'int', dataLength: null, dataPrecision: 11, dataScale: 0, nullable: 'Y', generated: false},
  })
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'id_tabla', dataType: 'int', dataLength: null, dataPrecision: 11, dataScale: 0, nullable: 'Y', generated: false},
  })
  idTabla?: number;
