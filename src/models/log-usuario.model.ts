...
@model({
  settings: {idInjection: false, mysql: {schema: 'neatpallet', table: 'log_usuario'}}
})
export class LogUsuario extends Entity {
  @property({
    type: 'number',
  ...
  @property({
    ...
    generated: false,
    mysql: {columnName: 'fechaRegistro', dataType: 'datetime', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  ...
  @property({
    ...
    length: 50,
    generated: false,
    mysql: {columnName: 'ip', dataType: 'varchar', dataLength: 50, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  ip?: string;
  ...
  @property({
    ...
    length: 500,
    generated: false,
    mysql: {columnName: 'masDatos', dataType: 'varchar', dataLength: 500, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  masDatos?: string;
  ...
  constructor(data?: Partial<LogUsuario>) {
    super(data);
  }
}

export interface LogUsuarioRelations {
  // describe navigational properties here
}

export type LogUsuarioWithRelations = LogUsuario & LogUsuarioRelations;
